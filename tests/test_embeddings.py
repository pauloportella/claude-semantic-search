...
from src.embeddings import EmbeddingConfig, EmbeddingGenerator, EmbeddingStats
...
class TestEmbeddingGenerator:
    ...
    def test_load_model_success(self, mock_st):
        ...
        mock_st.assert_called_once_with("all-MiniLM-L6-v2", cache_folder=None)
    ...
    def test_load_model_with_cache_dir(self, mock_st):
        ...
        mock_st.assert_called_once_with("all-mpnet-base-v2", cache_folder="/tmp/cache")
    ...
    def test_generate_single_embedding(self, mock_st):
        ...
        mock_model.encode.assert_called_once_with(
            "test text", normalize_embeddings=True, show_progress_bar=False
        )
